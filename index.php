...
<body class="page">
	...
	<section class="spiral_section_tc no_padding center_aligned" style="background-color: black">
		<div class="spiral_section_content">
			<div class="spiral_container">
			<span class="clear spacer_100"></span>
				

				<div id="logo" class="spiral-animo" data-animation="fadeIn" data-trigger_pt="0" data-duration="1000" data-delay="0">
					<a href="#">
						<img id="main_logo" src="images/logo.png" alt="Spiral">
					</a>
				</div><span class="clear spacer_40"></span>
				<h3 style="color: #fff">SELECT YOUR LANGUAGE</h3>
			...
			<div class="spiral_column_tc_span2 spiral-animo" data-animation="fadeInLeft" data-trigger_pt="0" data-duration="1000" data-delay="600" lang="en">
				<div class="spiral_service_box spiral_service_box_unboxed_round ">
					<div class="spiral_service_box_header">
						<div class="spiral_icon_boxed service_box_unboxed_round_bg" style="background-color: #000">
						<!-- <i class="tmf-cup service_box_unboxed_round_color"></i> -->
 <img src="images/us.svg" title="es" width="60px"    style="margin-top: 42px;" ></img>
			...
			<div class="spiral_column_tc_span2 spiral-animo" data-animation="fadeInRight" data-trigger_pt="0" data-duration="1000" data-delay="1000" lang="es">
				<div class="spiral_service_box spiral_service_box_unboxed_round ">
					<div class="spiral_service_box_header">
						<div class="spiral_icon_boxed service_box_unboxed_round_bg" style="background-color: #000">
						<!-- <i class="tmf-cup service_box_unboxed_round_color"></i> -->
<img src="images/es.svg" title="es" width="60px"    style="margin-top: 42px;" ></img>
			...
			<span class="clear spacer_50"></span>
		</section>
<section>
