        ...
        <div class="headline_image headline_style_about_us">
            <div class="container">
                <div class="row" style="margin-top: 50px">
                    <div class="span12 headline_title spiral-animo" data-animation="fadeInDown" data-trigger_pt="0"
                         data-duration="1000" data-delay="200">
                        <h2 class="center_aligned" style="text-align: center;margin-top: 50px">Try one of our services!</h2>
                    </div>
                    <h3 class="white_text spiral-animo" data-animation="fadeInDown" data-trigger_pt="0"
                        data-duration="1000" data-delay="300" style="text-align: center;">
    ...
    <section id="who_we_are" class="spiral_section_tc section_with_header no_padding_bottom">
        <header>
            <div class="spiral_container">
                <h3>
                    Ratione <strong>incidunt</strong> elit
                </h3>
            </div>
        </header>
        <div class="spiral_section_content">
            ...
            <span>
              ...
              quality per se.
                    ...
                    <div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima, minus iure accusantium
                            dolores, officiis eveniet architecto error placeat ratione incidunt?</p>
                    </div>
                    <div>
                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Minima, minus iure accusantium
                            dolores, officiis eveniet architecto error placeat ratione incidunt?</p>
                ...
                <div class="spiral_column_tc_span6">
                    <div class="spiral-accordion " data-expanded="1">
                        ...
                        <div class="spiral-accordion-body">
                            Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab vel mollitia dignissimos
                            cupiditate rerum facilis similique vero possimus, dolor, voluptatibus minus enim aspernatur.
                            Vel, molestias aut.
                        </div>
                        <h3>
                            Voluptatibus minus
