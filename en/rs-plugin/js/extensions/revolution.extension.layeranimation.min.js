...
!function (a) {
    ...
    jQuery.extend(!0, t, {
        animcompleted: function (a, e) {
            var i = a.data("videotype"), n = a.data("autoplay"), o = a.data("autoplayonlyfirsttime");
            ...
            var t = parseInt(a.data("startslide"), 0), i = parseInt(a.data("endslide"), 0);
            ...
            var o = "carousel" === e.sliderType ? 0 : e.width / 2 - e.gridwidth[e.curWinRange] * e.bw / 2, r = 0,
                d = a.data("index");
            ...
            var x = y, T = h(a, n, "in", !0), L = a.data("_pw") || a.closest(".tp-parallax-wrap"),
                W = a.data("_lw") || a.closest(".tp-loop-wrap"), C = a.data("_mw") || a.closest(".tp-mask-wrap"),
                j = a.data("responsive") || "on", I = a.data("responsive_offset") || "on",
                R = a.data("basealign") || "grid", k = "grid" === R ? n.width : n.ulw,
                _ = "grid" === R ? n.height : n.ulh, S = jQuery("body").hasClass("rtl");
            if (a.data("_pw") || (a.data("_pw", L), a.data("_lw", W), a.data("_mw", C)), "fullscreen" == n.sliderLayout && (u = _ / 2 - n.gridheight[n.curWinRange] * n.bh / 2), ("on" == n.autoHeight || void 0 != n.minHeight && n.minHeight > 0) && (u = n.conh / 2 - n.gridheight[n.curWinRange] * n.bh / 2), 0 > u && (u = 0), n.debugMode) {
                a.closest("li").find(".helpgrid").css({top: u + "px", left: r + "px"});
            ...
            if ("off" == Q || k < n.hideCaptionAtLimit && "on" == a.data("captionhidden") || k < n.hideAllCaptionAtLimit ? a.addClass("tp-hidden-caption") : a.removeClass("tp-hidden-caption"), a.data("layertype", "html"), 0 > r && (r = 0), void 0 != a.data("thumbimage") && void 0 == a.data("videoposter") && a.data("videoposter", a.data("thumbimage")), a.find("img").length > 0) {
                var M = a.find("img");
                a.data("layertype", "image"), 0 == M.width() && M.css({width: "auto"}), 0 == M.height() && M.css({height: "auto"}), void 0 == M.data("ww") && M.width() > 0 && M.data("ww", M.width()), void 0 == M.data("hh") && M.height() > 0 && M.data("hh", M.height());
                var O = M.data("ww"), H = M.data("hh"), B = "slide" == R ? n.ulw : n.gridwidth[n.curWinRange],
                    ...
                    F = "full" === O || "full-proportional" === O, D = "full" === H || "full-proportional" === H;
                if ("full-proportional" === O) {
                    var P = M.data("owidth"), X = M.data("oheight");
            ...
            if ("slide" === R && (r = 0, u = 0), a.hasClass("tp-videolayer") || a.find("iframe").length > 0 || a.find("video").length > 0) {
                ...
                var M = a.find("iframe") ? a.find("iframe") : M = a.find("video"), V = a.find("iframe") ? !1 : !0,
                    N = a.hasClass("coverscreenvideo");
                M.css({display: "block"}), void 0 == a.data("videowidth") && (a.data("videowidth", M.width()), a.data("videoheight", M.height()));
                ...
                if ("auto" == $.lineHeight && ($.lineHeight = $.fontSize + 4), a.hasClass("fullscreenvideo") || N) {
                    ...
                    var G = _;
                    "on" == n.autoHeight && (G = n.conh), a.css({width: k, height: G})
            ...
            var U = a.outerHeight(), q = a.css("backgroundColor");
            ...
            var J = 0 == E.voa.length ? 0 : E.voa, K = 0 == E.hoa.length ? 0 : E.hoa,
                aa = 0 == E.elx.length ? 0 : E.elx, ea = 0 == E.ely.length ? 0 : E.ely, ta = a.outerWidth(!0),
                ia = a.outerHeight(!0);
            ...
            var sa = a.data("lasttriggerstate"), la = a.data("triggerstate"), pa = a.data("start") || 100,
                ha = a.data("end"), ca = b ? 0 : "bytrigger" === pa || "sliderenter" === pa ? 0 : parseFloat(pa) / 1e3,
                ga = aa + r, ma = ea + u, ua = a.css("z-Index");
            ...
            var va = a.data("timeline") ? a.data("timeline").time() : 0,
                ...
                wa = a.data("timeline") || new punchgs.TimelineLite({smoothChildTiming: !0});
            if (fa = jQuery.isNumeric(fa) ? fa : 0, wa.pause(), 1 > fa && 1 != a.data("outstarted") || 2 == T || b) {
                ...
                if (!a.data("$anims") || b || Ta) {
                    ...
                    Wa = s(Wa, a.data("transform_idle")), La = s(Wa, a.data("transform_in"), 1 == n.sdir), ja && (Ca = s(Ca, a.data("transform_hover")), Ca = c(Ca, a.data("style_hover")), a.data("hover", Ca)), La.elemdelay = void 0 == a.data("elementdelay") ? 0 : a.data("elementdelay"), Wa.anim.ease = La.anim.ease = La.anim.ease || punchgs.Power1.easeInOut, ja && !a.hasClass("rs-hover-ready") && (a.addClass("rs-hover-ready"), a.hover(function (a) {
                        var e = jQuery(a.currentTarget), t = e.data("hover"), i = e.data("timeline");
                        ...
                        var e = jQuery(a.currentTarget), t = e.data("timeline");
                ...
                var Ia = l(a.data("mask_in")), Ra = new punchgs.TimelineLite;
                if (xa.f.anim.x = xa.f.anim.x * n.bw || d(xa.f.anim.x, n, ta, ia, ma, ga, "horizontal"), xa.f.anim.y = xa.f.anim.y * n.bw || d(xa.f.anim.y, n, ta, ia, ma, ga, "vertical"), 2 != T || b) {
                    ...
                    if (xa.f.anim.visibility = "hidden", Ra.eventCallback("onStart", function () {
                            punchgs.TweenLite.set(a, {visibility: "visible"}), a.data("iframes") && a.find("iframe").each(function () {
                    ...
                    } else wa.add(punchgs.TweenLite.set(C, {overflow: "visible"}, La.elemdelay), 0)
                }
            ...
            if (e = e || a.data("_mw"), t = t || a.data("_pw"), a.data("outstarted", 1), a.data("timeline")) a.data("timeline").pause(); else if (void 0 === a.data("_pw"))return;
            var r = new punchgs.TimelineLite, p = new punchgs.TimelineLite, h = new punchgs.TimelineLite,
                ...
                u = void 0 == a.data("endelementdelay") ? 0 : a.data("endelementdelay"), v = a.innerWidth(),
                f = a.innerHeight(), w = t.position();
            ...
            g.anim.x = g.anim.x * o.bw || d(g.anim.x, o, v, f, w.top, w.left, "horizontal"), g.anim.y = g.anim.y * o.bw || d(g.anim.y, o, v, f, w.top, w.left, "vertical"), p.eventCallback("onStart", function () {
                ...
                punchgs.TweenLite.set(a, {visibility: "hidden"}), punchgs.TweenLite.set(t, {visibility: "hidden"});
                var e = {};
            ...
            var i = a.data("index"), n = new Array;
    ...
    var i = function () {
        ...
        if (a.split("{").length > 1) {
            var t = a.split(","), i = parseFloat(t[1].split("}")[0]);
        ...
        if (a.hasClass("tp-static-layer")) {
            var o = parseInt(a.data("startslide"), 0), r = parseInt(a.data("endslide"), 0),
                d = e.c.find(".processing-revslide").index(), s = -1 != d ? d : e.c.find(".active-revslide").index();
        ...
        if ("off" === i && (r = 1, d = 1), "auto" == o.lineHeight && (o.lineHeight = o.fontSize + 4), !a.hasClass("tp-splitted")) {
            ...
            if (s && punchgs.TweenLite.set(a, o.styleProps), punchgs.TweenLite.set(a, {
                ...
                var l = "slide" == o.basealign ? e.ulw : e.gridwidth[e.curWinRange],
                    p = "slide" == o.basealign ? e.ulh : e.gridheight[e.curWinRange], h = u(o.maxWidth, r, "none", l),
                    c = u(o.maxHeight, d, "none", p), v = u(o.minWidth, r, "0px", l), f = u(o.minHeight, d, "0px", p);
        ...
        if (a.hasClass("rs-pendulum") && void 0 == a.data("loop-timeline")) {
            ...
            t *= e, i *= e, a.data("loop-timeline").append(new punchgs.TweenLite.fromTo(a, n, {
                ...
                rotation: t, ease: r, onComplete: function () {
        ...
        if (a.hasClass("rs-rotate") && void 0 == a.data("loop-timeline")) {
            ...
            n = void 0 == a.data("speed") ? 2 : a.data("speed"), o = void 0 == a.data("origin") ? "50% 50%" : a.data("origin"), r = void 0 == a.data("easing") ? punchgs.Power2.easeInOut : a.data("easing"), t *= e, i *= e, a.data("loop-timeline").append(new punchgs.TweenLite.fromTo(a, n, {
                ...
                rotation: i, ease: r, onComplete: function () {
                    a.data("loop-timeline").restart()
                }
            }))
        }
        if (a.hasClass("rs-slideloop") && void 0 == a.data("loop-timeline")) {
            a.data("loop-timeline", new punchgs.TimelineLite);
            var d = void 0 == a.data("xs") ? 0 : a.data("xs"), s = void 0 == a.data("ys") ? 0 : a.data("ys"),
                l = void 0 == a.data("xe") ? 0 : a.data("xe"), p = void 0 == a.data("ye") ? 0 : a.data("ye"),
                n = void 0 == a.data("speed") ? 2 : a.data("speed"),
            ...
            d *= e, s *= e, l *= e, p *= e, a.data("loop-timeline").append(new punchgs.TweenLite.fromTo(a, n, {
                ...
                y: p,
                ease: r
            })), a.data("loop-timeline").append(new punchgs.TweenLite.fromTo(a, n, {force3D: "auto", x: l, y: p}, {
                x: d,
                y: s,
                onComplete: function () {
                    a.data("loop-timeline").restart()
        ...
        if (a.hasClass("rs-pulse") && void 0 == a.data("loop-timeline")) {
            ...
            var h = void 0 == a.data("zoomstart") ? 0 : a.data("zoomstart"),
                ...
                n = void 0 == a.data("speed") ? 2 : a.data("speed"),
                r = void 0 == a.data("easing") ? punchgs.Power2.easeInOut : a.data("easing");
            a.data("loop-timeline").append(new punchgs.TweenLite.fromTo(a, n, {force3D: "auto", scale: h}, {
                scale: c,
                ease: r
            })), a.data("loop-timeline").append(new punchgs.TweenLite.fromTo(a, n, {
                force3D: "auto",
        ...
        if (a.hasClass("rs-wave") && void 0 == a.data("loop-timeline")) {
            ...
            var g = void 0 == a.data("angle") ? 10 : parseInt(a.data("angle"), 0),
                ...
                o = void 0 == a.data("origin") ? "50% 50%" : a.data("origin"), u = o.split(" "), v = new Object;
